...
const RequirementList = () => {
  ...
  useEffect(() => {
    ...
    // === เพิ่มฟัง event badgeCountsUpdated เพื่ออัปเดต cancel list แบบ real-time ===
  ...
  return (
    ...
    >
      ...
      >
        รายการปฏิเสธอนุมัติการยืมครุภัณฑ์
      </motion.h1>
      <div className="space-y-6">
        ...
        {rejectedList.map((request, index) => {
