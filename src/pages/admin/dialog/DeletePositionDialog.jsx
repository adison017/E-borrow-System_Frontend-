...
export default function DeletePositionDialog({ open, onClose, selectedPosition, onConfirm }) {
...
+                  </svg>
            ...
            <div className="py-2">
              <div className="text-sm text-gray-600 mb-2">คุณแน่ใจว่าต้องการลบตำแหน่งนี้หรือไม่?</div>
              <div className="mt-2 bg-gray-50 p-3 rounded-lg">
                <div className="font-medium text-lg text-gray-900">{selectedPosition?.position_name}</div>
              </div>
            </div>
